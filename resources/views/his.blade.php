...
<body style = "border-left: 15px solid yellow; border-right: 15px solid yellow">
<div class="container">
  <div class="row">
    <div class="col imageColumn d-flex flex-column justify-content-center align-items-center">
      <div class="row">
        <img class="image" src="/schools/stjoseph.png" alt="" onerror="this.src='/schools/HIS.png'">
      </div>
      <div class="row">
        <form>
    ...
    <div class="col detailsColumn d-flex justify-content-center align-items-center">
      <div class="detailsContainer">
        <h1 class="schoolName" style="font-weight: 700; margin-top: 100px;">Hope Integrated School</h1>
        ...
        <h4 class="schoolAddress" style="font-weight: 300; margin-top: 65px">Iris St. Fairview Q.C., Quezon City, Philippines</h4>
