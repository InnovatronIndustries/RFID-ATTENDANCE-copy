    ...
    */
    ...
    'disks' => [
        ...
        's3' => [
            ...
            'use_path_style_endpoint' => array_key_exists('AWS_USE_PATH_STYLE_ENDPOINT', $_SERVER) ? ($_SERVER['AWS_USE_PATH_STYLE_ENDPOINT'] === 'false' ? false : true) : env('AWS_USE_PATH_STYLE_ENDPOINT'),
            'visibility' => 'public',
            'throw' => false,
        ],
    ],
